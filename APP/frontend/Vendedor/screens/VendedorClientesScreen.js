...
const VendedorClientesScreen = ({ navigation }) => {
    ...
    const renderClientItem = ({ item }) => (
        <TouchableOpacity
            ...
            onPress={() => navigation.navigate('VendedorDetalleCliente', { client: item })}
        >
    ...
    return (
        <View style={styles.screen}>
            ...
            <ScreenHeader title="Mis Clientes" subtitle="Gestiona tu cartera de clientes" />
...
const styles = StyleSheet.create({
    ...
    searchContainer: {
        ...
        paddingBottom: 16,
        marginTop: 16, // Added margin to separate from header
